...
import com.droidnest.studio.pekualatest.data.repository.DataStoreOperationsImpl.Companion.PREFERENCES_NAME
...
class DataStoreOperationsImpl(context: Context) : DataStoreOperation {
